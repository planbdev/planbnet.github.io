...
var _tinySlider = __webpack_require__(8);
...
(function () {
    var PLAN_MODAL = document.querySelectorAll('.js-plan-modal');

    if (PLAN_MODAL != null) {
        var PLAN_MODAL_CLOSE_MENU = document.querySelectorAll('.js-close-plan-modal');
        var PLAN_MODAL_CONTAINER = document.querySelectorAll('.plan-modal');

        PLAN_MODAL.forEach(function (item) {
            item.addEventListener('click', function (e) {
                e.preventDefault();

                var PLAN_MODAL_CNT = document.getElementById(item.getAttribute('href'));

                PLAN_MODAL_CNT.setAttribute('aria-expanded', 'true');
                PLAN_MODAL_CNT.classList.add(OPEN_CLASS);
                TAG_HTML.classList.add(HIDDEN_CLASS);
                TAG_BODY.classList.add(HIDDEN_CLASS);
            });
        });
        ...
        PLAN_MODAL_CLOSE_MENU.forEach(function (item) {
            item.addEventListener('click', function (e) {
                ...
                PLAN_MODAL_CONTAINER.forEach(function (item) {
